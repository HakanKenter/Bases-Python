...
'''
Exercice
Ecrire un programme qui demande à l'utilisateur son identifiant
Si l'identifiant est "Thibaut", demander le mot de passe
Si le mot de passe est "azerty", afficher "Bienvenue", sinon afficher
"mot de passe incorrect"
Si l'identifiant n'est pas "Thibaut", afficher "Identifiant inconnu"
'''

identifiant = "Thibaut"
mdp = "azerty"
identifiantQuestion = input("Quel est ton identifiant ?")

if identifiantQuestion == identifiant :
    mdpQuestion = input("Quel est ton mot de passe ?")  
    if mdpQuestion == mdp :
        print('Bienvenue')
    else : 
